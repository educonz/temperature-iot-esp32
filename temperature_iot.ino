...
void sendHttp(String pathUri, String body){
 ...
 http.begin("https://YOUR_URL/api/v1" + pathUri);
 http.addHeader("Content-Type", "application/json"); 
 http.addHeader("Token", "YOUR_TOKEN"); 
...
void loop(){
  if(WiFi.status()== WL_CONNECTED){
      ...
      sendHttp("/sensorstate", temperatureStatus);
      ...
      sendHttp("/sensorstate", himidityStatus);
